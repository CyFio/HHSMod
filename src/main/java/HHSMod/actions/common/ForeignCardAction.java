...
public class ForeignCardAction extends AbstractGameAction {
    private boolean retrieveCard = false;
    private final AbstractCard.CardType ctype;
    private final boolean bFreeForTurn;
    private final boolean bFreeForBattle;
    private final boolean upgrade;

    public ForeignCardAction(boolean upgrade, AbstractCard.CardType type, boolean bFreeForTurn, boolean bFreeForBattle)
    {
        this.ctype = type;
    ...
    private ArrayList<AbstractCard> generateCardChoices() {
        ...
        for(AbstractCard.CardColor color : colors)
        {
            ...
            if(color != AbstractCard.CardColor.COLORLESS && color != AbstractCard.CardColor.CURSE)
            {
                ...
                AbstractCard card = CardLibraryHelper.GetRandomCard(color, ctype, cardRarity, true);
                if(card == null)
                {
                    continue;
                }
